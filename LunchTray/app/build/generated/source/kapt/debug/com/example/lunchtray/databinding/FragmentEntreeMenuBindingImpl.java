...
public class FragmentEntreeMenuBindingImpl extends FragmentEntreeMenuBinding implements com.example.lunchtray.generated.callback.OnClickListener.Listener {
    ...
    protected void executeBindings() {
        ...
        java.lang.String subtotalAndroidStringSubtotalViewModelEntreePrice = null;
        ...
        if ((dirtyFlags & 0xdL) != 0) {
            ...
            if ((dirtyFlags & 0xcL) != 0) {
                ...
                subtotalAndroidStringSubtotalViewModelEntreePrice = subtotal.getResources().getString(R.string.subtotal, viewModelEntreePrice);
        }
        // batch finished
        if ((dirtyFlags & 0x8L) != 0) {
            ...
            this.chili.setOnClickListener(mCallback1);
            this.nextButton.setOnClickListener(mCallback5);
            this.pasta.setOnClickListener(mCallback2);
            this.skillet.setOnClickListener(mCallback3);
        }
        if ((dirtyFlags & 0xdL) != 0) {
            // api target 1
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.subtotal, subtotalAndroidStringSubtotalViewModelEntreePrice);
        }
        if ((dirtyFlags & 0xcL) != 0) {
            // api target 1
