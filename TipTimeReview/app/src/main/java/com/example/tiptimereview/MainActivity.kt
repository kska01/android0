package com.example.tiptimereview
...
import com.example.tiptimereview.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Set up a click listener on the EditText field to listen for "enter" button presses
